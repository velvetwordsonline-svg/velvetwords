        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/content-disclaimer" className="text-gray-400 hover:text-primary transition-colors text-sm">
                  Content Disclaimer
                </Link>
              </li>
              <li>
                <Link to="/payment-policy" className="text-gray-400 hover:text-primary transition-colors text-sm">
                  Payment Policy
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-white/10 pt-8">
          ...
          <div className="border-t border-white/10 pt-6">
            <p className="text-gray-500 text-xs text-center sm:text-left">
              © {new Date().getFullYear()} Velvet Words. All rights reserved. Made with passion for stories.
            </p>
          </div>
        </div>
      </div>
