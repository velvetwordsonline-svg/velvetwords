...
export const categories: Category[] = [
  {
    ...
    description: "Modern love stories set in today's world",
  ...
  },
  {
    ...
    description: "Supernatural beings and otherworldly connections",
  ...
  },
  {
    id: "cat-3",
    name: "Dark Romance",
    description: "Intense, obsessive, and dangerously addictive",
  ...
  },
  {
    ...
    description: "Magic, kingdoms, and epic love stories",
  ...
  },
  {
    id: "cat-5",
    name: "LGBTQ+ Romance",
    description: "Diverse love stories and connections",
