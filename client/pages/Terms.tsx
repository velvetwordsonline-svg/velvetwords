      ...
      <div className="pt-24 pb-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gray-900/50 rounded-lg p-8 border border-purple-600/30">
            <p className="text-gray-400 text-sm mb-6">Last updated on 02-02-2026 10:50:08</p>
            
            <div className="text-gray-300 space-y-6 leading-relaxed">
              <p>
                These Terms and Conditions, along with privacy policy or other terms ("Terms") constitute a binding agreement by and between Velvet Words, ("Website Owner" or "we" or "us" or "our") and you ("you" or "your") and relate to your use of our website, goods (as applicable) or services (as applicable) (collectively, "Services").
              </p>
              ...
              <ul className="space-y-4 list-disc list-inside">
                ...
                <li>
                  All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Gurugram, Haryana.
                </li>
